...
<script type="text/javascript">
    tinyMCE.init({
        ...
        // Theme options
        theme_advanced_buttons1 : "bold,italic,underline,|,justifyleft,justifycenter,justifyright,justifyfull,|,forecolor,backcolor,preview,|,styleselect,formatselect,fontselect,fontsizeselect",
...
<p class="titulo">Actualizar Contenido</p>
<p class="subtitulo">Ingresar Datos</p>
<form class="forminsert" action="{$smarty.const.WEB_ROOT}/admin/noticias/svc/actualizar-noticia/{$noticia.not_id}" method="post" enctype="multipart/form-data" >
    <table class="stats">
        <tr>
            <td class="rig">Titulo :</td>
            <td class="let">
                <input type="text" name="not_titulo" id="not_titulo" value="{$noticia.not_titulo}" class="text w-40 span"/>
        ...
        <tr>
            ...
            <td class="let">
                <textarea  name="not_descripcion" id="not_descripcion" class="text h-10 span">{$noticia.not_descripcion}</textarea>
                <p class="error">{$error.not_descripcion}</p>
            </td>
        </tr>
        <tr>
            <td class="rig">Foto Actual :</td>
            <td class="let"><img src="{$noticia.imagen}"/></td>
        </tr>
        <tr>
